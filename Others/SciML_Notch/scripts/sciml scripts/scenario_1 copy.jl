...
function lotka!(du, u, p, t)
    α, β, γ, δ = p
    du[1] = α * u[1] - β * u[2] * u[1] + β * γ * (u[2] - u[1])^2 - β * δ * u[1] * u[3]
    du[2] = -γ * u[1] * u[2] - δ * u[2] -  γ * u[2]*u[3]
    du[3] = -δ * u[3] - β * u[2] * u[3] + δ * u[3]*u[1]
    # du[4] = u[3] * u[2] - β * u[3] * u[4]
end

# Define the experimental parameter
tspan = (0, 60)
u0 = Float32[0.44249296, 4.6280594, 0.6280594]
...
U = FastChain(
    FastDense(4, 5, rbf), FastDense(5, 5, rbf), FastDense(5, 5, rbf), FastDense(5, 3)
)
...
function ude_dynamics!(du, u, p, t, p_true)
    ...
    du[1] = p_true[1] * u[1] + û[1] + û[3]
    du[2] = -p_true[4] * u[2] + û[2]
    du[3] = p_true[4] * u[2] - p_true[2] * u[3] * u[1]
    du[4] = u[1] * u[2] - p_true[2] * u[4] * u[1]
end
